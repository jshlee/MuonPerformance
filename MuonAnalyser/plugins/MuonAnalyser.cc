...
class MuonAnalyser : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
	...
	private:
		...
		TH1D *hmu_pfIso_R04, *hmu_pfIso_R03;
...
MuonAnalyser::MuonAnalyser(const edm::ParameterSet& pset)
{
	...
	hmu_pfIso_R04 = fs->make<TH1D>("hmu_pfIso_R04","Mu_PFIso_{R04}",20,0,5);
	hmu_pfIso_R03 = fs->make<TH1D>("hmu_pfIso_R03","Mu_PFIso_{R03}",20,0,5);
