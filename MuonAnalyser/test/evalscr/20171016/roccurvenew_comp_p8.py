...
dicTitle = {
  ...
  "PF_Run2": "I^{PF}, (new) Run 2, <PU> = 27, #sqrt{s} = 13 TeV, NH < 0.001", 
  "PF2_Run2": "I^{PF}, (new) Run 2, <PU> = 27, #sqrt{s} = 13 TeV, NH < 0.00001", 
  "PFbeta_Run2": "I^{PF}, (#beta) Run 2, <PU> = 27, #sqrt{s} = 13 TeV", 
...
#arrLineColor = [1, 2, 8, 1, 2, 8, 4, 8, 8, 20]
#arrLineStyle = [1, 1, 1, 2, 2, 2, 1, 1, 1, 1]
arrLineColor = [1, 2, 3, 4, 8, 8, 4, 8, 8, 20]
arrLineStyle = [1, 1, 1, 1, 1, 2, 1, 1, 1, 1]
...
#arrCurveName = ["Trk", "PFbeta", "PF", "Trk_Run2", "PFbeta_Run2", "PF_Run2"]
...
#arrCurveName = ["Trk", "PF"]
arrCurveName = ["PF", "Trk_Run2", "PFbeta_Run2", "PF_Run2"]
...
canv.Modified()
canv.Update()
strOutFile = "ROCCurve_TDR_new_for_page8_20171026_tdrrun2_test.root"
