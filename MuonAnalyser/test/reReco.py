...
# with command line options: step3 --conditions auto:phase2_realistic -n 10 --era Phase2C2_timing --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --geometry Extended2023D4 -n 10000 --filein file:step2.root --fileout file:step3.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/xrootd/store/relval/CMSSW_9_0_0_pre4/RelValTenMuExtendedE_0_200/GEN-SIM-RECO/90X_upgrade2023_realistic_v3_2023D4Timing-v1/10000/3CD32386-B7EC-E611-81DF-0025905B85AA.root'),
...
#process.reconstruction_step = cms.Path(process.muons)
