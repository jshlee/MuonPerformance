...
#dicColor = {"Trk": 1, "PF001": 2, "TrkRun2": 1, "PFRun2": 2}
dicColor = {"Trk": 1, "PF001": 2, "TrkRun2": 4, "PFRun2": 8}

#dicLineStyle = {"Trk": 1, "PF001": 1, "TrkRun2": 2, "PFRun2": 2}
dicLineStyle = {"Trk": 1, "PF001": 1, "TrkRun2": 1, "PFRun2": 1}
...
arrCurveName = ["TrkRun2", "PFRun2", "Trk", "PF001"]
...
for strCurve in arrCurveName:
  ...
  print "Survived : %lf (sig), %lf (bkg)"%(nTotalSig, nTotalBkg)
...
canv.Modified()
canv.Update()
strOutFile = "ROCCurve_TDR_new_with_Run2_multiplicity_20170814.root"
